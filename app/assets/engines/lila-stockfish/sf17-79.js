    ...
    return async function (moduleArg = {}) {
        ...
        if (ia || k)
            k
                ...
                p.startsWith("blob:") ? (p = "") : (p = p.slice(0, p.replace(/[?#].*/, "").lastIndexOf("/") + 1)),
                k &&
                    (va = (a) => {
                ...
                try {
                    ...
                    if ("load" === e) {
                        ...
                        for (const g of d.Xa)
                            if (!h[g] || h[g].proxy)
                                (h[g] = (...m) => {
                                    postMessage({ la: "callHandler", Wa: g, Ua: m });
                                }),
                                    "print" == g && (wa = h[g]),
                                    "printErr" == g && (q = h[g]);
                        t = d.jb;
                        ...
                        "setimmediate" !== d.target &&
                            ("checkMailbox" === e
                                ? Ia && Oa()
                                : e && (q(`worker: received unknown command ${e}`), q(d)));
                } catch (f) {
                    throw (Pa(), f);
                }
            }
        ...
        l ||
            (h.wasmMemory
                ? (t = h.wasmMemory)
                : (t = new WebAssembly.Memory({ initial: 1024, maximum: 32768, shared: !0 })),
            z());
        function Qa() {
            l
                ? startWorker(h)
                : (h.noFSInit ||
                      Ra ||
                      ((Ra = !0),
                      Sa("/dev/tty", "/dev/stdin"),
                      Sa("/dev/tty", "/dev/stdout"),
                      Sa("/dev/tty1", "/dev/stderr"),
                      Ta("/dev/stdin", 0),
                      Ta("/dev/stdout", 1),
                      Ta("/dev/stderr", 1)),
                  C.E(),
        ...
        var Ib = (a) =>
            new Promise((b) => {
                a.onmessage = (f) => {
                    ...
                    } else if ("checkMailbox" === g) Oa();
                    else if ("spawnThread" === g) Jb(f);
                    else if ("cleanupThread" === g) Xb(J[f.gb]);
                ...
                a.postMessage({ la: "load", Xa: c, jb: t, kb: xa });
            });
        function Vb(a) {
            l ? a() : Promise.all(H.map(Ib)).then(a);
        }
        function Hb() {
            var a = new Worker(new URL("sf17-79.js", import.meta.url), { type: "module", name: "em-pthread" });
            H.push(a);
        }
        var Ja = (a) => {
                z();
        ...
        var cb = (a, b, c, d) => {
            ...
            Q = (a, b = 0, c = NaN) => {
                var d = b + c;
                for (c = b; a[c] && !(c >= d); ) ++c;
                if (16 < c - b && a.buffer && jc)
                    return jc.decode(a.buffer instanceof ArrayBuffer ? a.subarray(b, c) : a.slice(b, c));
                for (d = ""; b < c; ) {
                    var e = a[b++];
                    if (e & 128) {
                        var f = a[b++] & 63;
                    ...
                    S.ia ||
                        (S.ia = {
                            ...
                            file: {
                                ...
                                stream: { ha: S.aa.ha, read: S.aa.read, write: S.aa.write, Na: S.aa.Na, Pa: S.aa.Pa },
                            },
                            link: { node: { qa: S.ca.qa, ka: S.ca.ka, ua: S.ca.ua }, stream: {} },
                            Ja: { node: { qa: S.ca.qa, ka: S.ca.ka }, stream: rc },
                        });
                    c = sc(a, b, c, d);
                    16384 === (c.mode & 61440)
                        ? ((c.ca = S.ia.dir.node), (c.aa = S.ia.dir.stream), (c.ba = {}))
                        : 32768 === (c.mode & 61440)
                          ? ((c.ca = S.ia.file.node), (c.aa = S.ia.file.stream), (c.ea = 0), (c.ba = null))
                          : 40960 === (c.mode & 61440)
                            ? ((c.ca = S.ia.link.node), (c.aa = S.ia.link.stream))
                            : 8192 === (c.mode & 61440) && ((c.ca = S.ia.Ja.node), (c.aa = S.ia.Ja.stream));
        ...
        function Ta(a, b, c = 438) {
            ...
            if (
                ...
                (e = d
                    ? 40960 === (d.mode & 61440)
                        ? 32
                        : 16384 === (d.mode & 61440) && ("r" !== Cc(b) || b & 576)
                          ? 31
                          : Bc(d, Cc(b))
                    : 44)
            )
            ...
            if (b & 512 && !f) {
                ...
                Gc(e, { size: 0, timestamp: Date.now() });
            }
            a: for (e = d; ; ) {
                if (e === e.parent) {
                    e = e.ma.Oa;
            ...
            b = Ec({ node: d, path: g, flags: b & -131713, seekable: !0, position: 0, aa: d.aa, hb: [], error: !1 });
            b.aa.open && b.aa.open(b);
            f &&
                ((c &= 511),
                (d = "string" == typeof d ? U(d, { Da: !0 }).node : d),
                Gc(d, { mode: (c & 4095) | (d.mode & -4096), fa: Date.now(), tb: void 0 }));
            return b;
        }
        function Sb(a) {
            ...
            try {
                ...
                switch (b) {
                    ...
                    case 21508:
                        if (!d.da) return -59;
                        if (d.da.na.$a)
                            for (e = O(), A(), A(), A(), A(), a = [], f = 0; 32 > f; f++) a.push(x()[e + f + 17]);
                        return 0;
                    case 21519:
                        if (!d.da) return -59;
                        e = O();
        ...
        var gb = () => Wa(""),
            ...
            Ma = (a) => {
                "function" === typeof Atomics.ib &&
                    (Atomics.ib(A(), a >> 2, a).value.then(Oa), (a += 128), Atomics.store(A(), a >> 2, 1));
            },
            Oa = () => {
                var a = Yb();
                a && (Ma(a), Mc(Nc));
            ...
            jb = (a, b, c, d, e) => {
                ...
                Oc.length = d;
                b = e >> 3;
                for (c = 0; c < d; c++) Oc[c] = w[b + 2 * c] ? w[b + 2 * c + 1] : Ga()[b + 2 * c + 1];
                return (0, Pc[a])(...Oc);
            },
            kb = () => {
                K = 0;
            ...
            lb = (a) => {
                l ? postMessage({ la: "cleanupThread", gb: a }) : Xb(J[a]);
            },
            mb = () => {},
            Qc = {},
        ...
        function wb(a, b) {
            ...
            Wc().forEach((d, e) => {
                var f = b + c;
                e = B()[(a + 4 * e) >> 2] = f;
                for (f = 0; f < d.length; ++f) x()[e++] = d.charCodeAt(f);
                x()[e] = 0;
                c += d.length + 1;
            });
            return 0;
        ...
        (function () {
            W("/dev");
            nc(259, { read: () => 0, write: (d, e, f, g) => g, ha: () => 0 });
            Jc("/dev/null", 259);
            mc(1280, pc);
            mc(1536, qc);
            Jc("/dev/tty", 1280);
                    ...
                    ma() {
                        ...
                        b.ca = {
                            ta(c, d) {
                                c = +d;
                                var e = V(c);
                                c = { parent: null, ma: { Oa: "fake" }, ca: { ua: () => e.path }, id: c + 1 };
                                return (c.parent = c);
                            },
                            Ha() {
        ...
        var Pc = [Db, Pb, cc, db, eb, fb, nb, wb, xb, zb, Ab, Bb, Cb],
            ...
            C = await (async function () {
                ...
                Xa ??= h.locateFile
                    ? h.locateFile
                        ? h.locateFile("sf17-79.wasm", p)
                        : p + "sf17-79.wasm"
                    : new URL("sf17-79.wasm", import.meta.url).href;
                try {
                    var c = await $a(b);

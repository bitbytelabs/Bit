...
var Sf17179Web = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    function Hb() {
      var a = new Worker(new URL("sf171-79.js", import.meta.url), {
        type: "module",
        name: "em-pthread"
      });
      H.push(a);
    ...
    var Pc = [Db, Pb, cc, db, eb, fb, nb, wb, xb, zb, Ab, Bb, Cb],
      ...
      C = await async function () {
        ...
        Xa ??= h.locateFile ? h.locateFile ? h.locateFile("sf171-79.wasm", p) : p + "sf171-79.wasm" : new URL("sf171-79.wasm", import.meta.url).href;
        try {
          var c = await $a(b);

var Fsf14Web = (() => {
    ...
    return async function (moduleArg = {}) {
            ...
            new Promise((b) => {
                a.onmessage = (f) => {
                    ...
                    if (f.Aa && f.Aa != Xb()) {
                        var m = J[f.Aa];
                        m
                            ? m.postMessage(f, f.Ra)
                            : q(
                                  `Internal error! Worker sent a message "${g}" to target pthread ${f.Aa}, but that thread no longer exists!`
                              );
                    } else if ("checkMailbox" === g) Oa();
                    else if ("spawnThread" === g) Ib(f);
                    else if ("cleanupThread" === g) Wb(J[f.fb]);
                    else if ("loaded" === g) (a.loaded = !0), b(a);
                    else if ("setimmediate" === f.target) a.postMessage(f);
                    else if ("callHandler" === g) h[f.Va](...f.Ta);
                ...
                a.postMessage({ ka: "load", Wa: c, ib: t, jb: xa });
            });
        function Ub(a) {
            l ? a() : Promise.all(H.map(Hb)).then(a);
        }
        function Gb() {
            var a = new Worker(new URL("fsf14.js", import.meta.url), { type: "module", name: "em-pthread" });
            H.push(a);
        }
        var Ja = (a) => {
                z();
                ...
                createNode(a, b, c, d) {
                    ...
                    S.ha ||
                        (S.ha = {
                            ...
                            Ia: { node: { pa: S.ba.pa, ja: S.ba.ja }, stream: qc },
                        });
                    c = rc(a, b, c, d);
                    16384 === (c.mode & 61440)
                        ? ((c.ba = S.ha.dir.node), (c.$ = S.ha.dir.stream), (c.aa = {}))
                        : 32768 === (c.mode & 61440)
                          ? ((c.ba = S.ha.file.node), (c.$ = S.ha.file.stream), (c.da = 0), (c.aa = null))
                          : 40960 === (c.mode & 61440)
                            ? ((c.ba = S.ha.link.node), (c.$ = S.ha.link.stream))
                            : 8192 === (c.mode & 61440) && ((c.ba = S.ha.Ia.node), (c.$ = S.ha.Ia.stream));
                        ...
                        void 0 !== b.size &&
                            ...
                            a.da != b &&
                                (0 == b
                                    ? ((a.aa = null), (a.da = 0))
                                    : ((c = a.aa),
                                      (a.aa = new Uint8Array(b)),
                                      c && a.aa.set(c.subarray(0, Math.min(b, a.da))),
                                      (a.da = b))));
                    },
                    sa() {
                        throw S.Ja;
                ...
                $: {
                    ...
                    write(a, b, c, d, e, f) {
                        ...
                        g >= f ||
                            ...
                            (g = a.aa),
                            (a.aa = new Uint8Array(f)),
                            0 < a.da && a.aa.set(g.subarray(0, a.da), 0));
                        if (a.aa.subarray && b.subarray) a.aa.set(b.subarray(c, c + d), e);
                        else for (f = 0; f < d; f++) a.aa[e + f] = b[c + f];
        ...
        function Ta(a, b, c = 438) {
            ...
            b = Dc({ node: d, path: g, flags: b & -131713, seekable: !0, position: 0, $: d.$, gb: [], error: !1 });
            b.$.open && b.$.open(b);
            f &&
                ((c &= 511),
                (d = "string" == typeof d ? U(d, { Ca: !0 }).node : d),
                Fc(d, { mode: (c & 4095) | (d.mode & -4096), ea: Date.now(), sb: void 0 }));
            return b;
        }
        function Rb(a) {
        ...
        var gb = () => Wa(""),
            ...
            Ma = (a) => {
                "function" === typeof Atomics.hb &&
                    (Atomics.hb(A(), a >> 2, a).value.then(Oa), (a += 128), Atomics.store(A(), a >> 2, 1));
            },
            Oa = () => {
                var a = Xb();
                a && (Ma(a), Lc(Mc));
            ...
            ib = (a, b) => {
                a == b
                    ? setTimeout(Oa)
                    : l
                      ? postMessage({ Aa: a, ka: "checkMailbox" })
            ...
            jb = (a, b, c, d, e) => {
                ...
                Nc.length = d;
                b = e >> 3;
                for (c = 0; c < d; c++) Nc[c] = w[b + 2 * c] ? w[b + 2 * c + 1] : Ga()[b + 2 * c + 1];
                return (0, Oc[a])(...Nc);
            },
            kb = () => {
                K = 0;
            ...
            lb = (a) => {
                l ? postMessage({ ka: "cleanupThread", fb: a }) : Wb(J[a]);
            },
            mb = () => {},
            Pc = {},
        ...
        (function () {
            W("/dev");
            mc(259, { read: () => 0, write: (d, e, f, g) => g, ga: () => 0 });
            Ic("/dev/null", 259);
            lc(1280, oc);
            lc(1536, pc);
            Ic("/dev/tty", 1280);
        ...
        var Oc = [Cb, Ob, bc, db, eb, fb, nb, vb, wb, yb, zb, Ab, Bb],
            ...
            C = await (async function () {
                ...
                Xa ??= h.locateFile
                    ? h.locateFile
                        ? h.locateFile("fsf14.wasm", p)
                        : p + "fsf14.wasm"
                    : new URL("fsf14.wasm", import.meta.url).href;
                try {
                    var c = await $a(b);

...
var Fsf14Web = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    function Gb() {
      var a = new Worker(new URL("fsf14.js", import.meta.url), {
        type: "module",
        name: "em-pthread"
      });
      H.push(a);
    ...
    var Oc = [Cb, Ob, bc, db, eb, fb, nb, vb, wb, yb, zb, Ab, Bb],
      ...
      C = await async function () {
        ...
        Xa ??= h.locateFile ? h.locateFile ? h.locateFile("fsf14.wasm", p) : p + "fsf14.wasm" : new URL("fsf14.wasm", import.meta.url).href;
        try {
          var c = await $a(b);

...
!function () {
  ...
  function q() {
    for (var e = [], n = arguments.length; n--;) if (isSafeKey(n)) {
      e[n] = arguments[n];
    }
  ...
  var Me = function (e, n) {
    ...
    Ze = function (e, n) {
      ...
      for (; o < i.length; o++) if (isSafeKey(o)) {
      ...
      return e.prototype.space = function (e) {
        ...
        if (e) {
          ...
          if (n.header.length === n.align.length) {
            ...
            for (i = n.cells.length, o = 0; o < i; o++) if (isSafeKey(o)) {

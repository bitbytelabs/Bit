...
export const posToTranslate = (bounds: ClientRect, bd: cg.BoardDimensions): ((pos: cg.Pos, asWhite: boolean) => cg.NumberPair) => (pos, asWhite) => [(asWhite ? pos[0] : bd.width - 1 - pos[0]) * bounds.width / bd.width, (asWhite ? bd.height - 1 - pos[1] : pos[1]) * bounds.height / bd.height];
